...
public class Translator {
	...
	protected Locale currentLocale; // Local is Java Built in Class
	private ResourceBundle resourceBundle; // ResourceBundle is Java Built in
											// Class

	public Translator(String localeString) {
		// Can we find the language in our supported locale?
