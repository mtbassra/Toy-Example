package ch.fhnw.richards.lecture04.sampleSolution.splashScreen;

import ch.fhnw.richards.lecture04.sampleSolution.Lecture04_sampleSolution;
...
public class Splash_Controller extends Controller<Splash_Model, Splash_View> {
    ...
    public Splash_Controller(final Lecture04_sampleSolution main, Splash_Model model, Splash_View view) {
        super(model, view);
